...
window.SCRIPTS = [ 118396797, 111773112, 108026253, 99767394, 108026252, 109387017, 110329954, 112098061, 114063573, 114085216, 118401522, 120163247, 120163248, 121963195, 123110240 ];
...
window.SCRIPTS = [118396797, 111773112, 108026253, 99767394, 108026252, 109387017, 109848422, 109848430, 110329954, 112098061, 114063573, 114085216, 118401522, 120163247, 120163248, 121963195, 123110240];
window.CONFIG_FILENAME = "config.json";
window.INPUT_SETTINGS = {
    useKeyboard: true,
    useMouse: true,
...
window.PRELOAD_MODULES = [{
    'moduleName': 'Ammo',
    'glueUrl': 'files/assets/120163247/1/ammo.wasm.js',
    'wasmUrl': 'files/assets/120163246/1/ammo.wasm.wasm',
    'fallbackUrl': 'files/assets/120163248/1/ammo.js',
    'preload': true
}, ];

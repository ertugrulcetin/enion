...
SCRIPTS = [ 118396797, 78753240, 111773112, 108026253, 99767394, 108026252, 109387017, 109848422, 109848430, 110329954, 112098061, 114063573, 114085216, 118401522, 118403201 ];
...
pc_FN = pc.FILLMODE_NONE;
pc_FKA = pc.FILLMODE_KEEP_ASPECT;
...
(function () {
    ...
    var pcBootstrap = {
        ...
        resizeCanvas: function (app, canvas) {
            ...
            if (fillMode == pc_FN || fillMode == pc_FKA) {
                if ((fillMode == pc_FN && canvas.clientHeight < window.innerHeight) || (canvas.clientWidth / canvas.clientHeight >= window.innerWidth / window.innerHeight)) {
